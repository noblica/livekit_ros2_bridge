...
public:
  ...
  // Answers a client's "request the current value of a topic" by dispatching the cached last
  ...
  // method's — see RpcRouter::requestCurrent.
  CurrentValueResult dispatchCurrentValue(
