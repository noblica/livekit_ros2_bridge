...
// Talkback playback fragments must not define endpoints; the bridge owns the
// single appsrc named here.
constexpr EndpointLayout makeTalkbackSinkLayout(const char * bridge_appsrc_name)
{
